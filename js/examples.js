...
var test = '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="variables_set" id="9%gvk/uW@@f/lTD(9`lR" x="50" y="70"><field name="VAR">föremål</field><value name="VALUE"><block type="graphics_pointer" id="vE6yp#SH`}m^iD-ZE||D"></block></value><next><block type="variables_set" id="oD2(hL(=C}I/;3:s~^Kz"><field name="VAR">kub</field><value name="VALUE"><block type="graphics_make_cube" id="7a/44l:+[9)WDi2zU4ql"><value name="Length"><block type="math_number" id="OyiOHGQ5QBty=Wxtr!Tl"><field name="NUM">10</field></block></value></block></value><next><block type="graphics_color" id="^RcH2HkK5QFx]Z+4PTv]"><value name="object"><block type="variables_get" id="41I6q^,ul2h!t{1b2B:i"><field name="VAR">kub</field></block></value><value name="color"><block type="colour_picker" id="*RP98DI9g^),UYIW:}i["><field name="COLOUR">#33cc00</field></block></value><next><block type="controls_repeat_ext" id="P;x|ef6{b}V;SL81#2uJ"><value name="TIMES"><block type="math_number" id="{C%+Z5vl%`p)P)+0Zhn)"><field name="NUM">10</field></block></value><statement name="DO"><block type="graphics_move_object" id="H31}M}xO,L/K]X|JQAHh"><field name="direction">up</field><value name="Object"><block type="variables_get" id="~ywEFR8.I.|v@JD[#F/*"><field name="VAR">föremål</field></block></value><next><block type="graphics_move_object" id="w-6U?XM}v@JUx%Nsn!!!"><field name="direction">right</field><value name="Object"><block type="variables_get" id="3T)1K8-VkqQt}QBfsG0?"><field name="VAR">föremål</field></block></value></block></next></block></statement><next><block type="variables_set" id="r+((A9yU}N]91E!vD/ZW"><field name="VAR">kub2</field><value name="VALUE"><block type="graphics_make_cube" id="*7++KKo^aqa[J}(1.Y6V"><value name="Length"><block type="math_number" id="*+Yc@nRXR_r#gmEOhGU^"><field name="NUM">10</field></block></value></block></value><next><block type="graphics_color" id="E=}Iew*._vSiaO`uuUx_"><value name="object"><block type="variables_get" id="]@Rah.P6/#GCk0L7Z88c"><field name="VAR">kub2</field></block></value><value name="color"><block type="colour_picker" id="O!6Nn1%mP+}19~to(:TO"><field name="COLOUR">#66ffff</field></block></value><next><block type="controls_repeat_ext" id="}tgZf=@np!ZM/1Mz+xP+"><value name="TIMES"><block type="math_number" id="xeGJG`/AEJk|0#CW4(pQ"><field name="NUM">5</field></block></value><statement name="DO"><block type="graphics_move_object" id="Q2mi%{)[^,:X(=/W^kOx"><field name="direction">down</field><value name="Object"><block type="variables_get" id="}dA*={YiDB6E#,Maa5//"><field name="VAR">föremål</field></block></value></block></statement><next><block type="variables_set" id="3eNpv}[r/q.?7kl%xzNg"><field name="VAR">kub3</field><value name="VALUE"><block type="graphics_make_cube" id=",XSDe-{ki;]Xw0H{O@}["><value name="Length"><block type="math_number" id="lQ9Llo1OF63`{ppJRm7+"><field name="NUM">10</field></block></value></block></value><next><block type="graphics_color" id="NRqSr2rYvQ;xi%r!uPsR"><value name="object"><block type="variables_get" id="`A@0oqKJ;?}h,h5/TW-p"><field name="VAR">kub3</field></block></value><value name="color"><block type="colour_picker" id="e^`=cuQZ,U^M}3A}s)@t"><field name="COLOUR">#3333ff</field></block></value></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></xml>';
