...
function Shape(size, type, scale){
  ...
  // BUG; Måste skriva om rotate grejerna. JAg bborde försöka efterlikna move så mycket som möjligt. Move funkar ju bra, rotate buggar till
  // Skillnaden gör det buggigt, fixa!
